...
`@curio/sdk/drizzle` exposes the SQL-backed adapter used when Curio repositories
...
The root SDK entrypoint should not always pull in the SQL driver and Drizzle
dependency graph.
