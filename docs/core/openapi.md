...
`@curio/core/openapi` is an advanced entrypoint that generates an OpenAPI 3.1
...
overloading the main core runtime story.
...
```ts
import * as v from "@valibot/valibot";
import { Route, withSchemas } from "@curio/core";
import { OpenAPI } from "@curio/core/openapi";
